	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarToggler">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a href="/index.php/formulaire/testconnexion" class="btn btn-danger btn-round">Se connecter</a>
				</li>
				<li class="nav-item">
					<a href="/index.php/formulaire/create" class="btn btn-danger btn-round">S'inscrire</a>
				</li>
			</ul>
		</div>
	</div>
