...
<nav>
	<ul>
		<div class="menu">
			<li><a href="/index.php/formulaire/ListeClient"><input type="button"
																				value="Tous les clients"></a></li>
			<li><a href="/index.php/formulaire/profilAdmin"><input type="button"
		...
		<table stylesheet="border=solid 1px black">
			...
			<?php foreach ($dataClient as $row) { ?>
				<tr>
					...
					<td>
						<a href="/index.php/formulaire/profilUser?id=<?php echo $row['idclient']; ?>"><input
								type="button" value="Compte du Client"></a></td>
					<td>
						<a href="/index.php/formulaire/modifClient?idclient=<?php echo $row['idclient']; ?>"><input
								type="button" value="Modifier client"></a></td>
					<td>
						<a href="/index.php/formulaire/supprUser?id=<?php echo $row['idclient']; ?>"><input
