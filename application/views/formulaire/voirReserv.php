...
<table stylesheet="border=solid 1px black">
	...
	<?php foreach($dataReservation as $row){ ?>
		<tr>
			...
			<td><a href="/index.php/formulaire/modifReservation?id=<?php echo $row['idreserv'];?>""><input type="button" value="Modifier la Reservation"></a></td>
			<td><a href="/index.php/formulaire/supprReservationAdmin?id=<?php echo $row['idreserv'];?>"><input type="button" value="Annuler la Reservation"></a></td>
		</tr>
	...
	<br><br><a href="/index.php/formulaire/profilPersoUser"><h3>Retour à mon profil</h3></a>
