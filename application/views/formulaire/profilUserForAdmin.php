...
<div class="nav-admin">
	...
	<nav>
		<ul>
			<div class="menu">
				<li><a href="/index.php/formulaire/ListeClient"><input type="button" value="Tous les clients"></a></li>
				<li><a href="/index.php/formulaire/profilAdmin"><input type="button" value="Mon profil"></a></li>
			</div>
		</ul>
	</nav>
			...
			<table stylesheet="border=solid 1px black">
				...
				<?php foreach ($dataReservation as $row) { ?>
					<tr>
						...
						<td>
							<a href="/index.php/formulaire/modifReservationAdmin?id=<?php echo $row['idreserv']; ?>""><input
								type="button" value="Modifier Reservation"></a></td>
						<td>
							<a href="/index.php/formulaire/supprReservationAdmin?id=<?php echo $row['idreserv']; ?>"><input
									type="button" value="Supprimer Reservation"></a></td>
						<td>
							<a href="/index.php/formulaire/validerReservation?id=<?php echo $row['idreserv']; ?>"><input
