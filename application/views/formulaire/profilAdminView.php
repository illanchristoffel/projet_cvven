	...
	<div class="wrap-reserv">
		...
		<div class="wrap-contents-profil">
			...
			<div class="wrap-input-modifID">
				...
				<br><br><a href="/index.php/formulaire/modifierIDAdmin"><input type="button"
																							value="Modifier son nom"></a><br><br>

				<a href="/index.php/formulaire/modifierPasswordAdmin"><input type="button"
																					 value="Changer son mot de passe"></a><br><br>

				<a href="/index.php/"><input type="button" value="Se déconnecter"></a>
